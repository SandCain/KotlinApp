...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val askMeButton : Button = findViewById(R.id.buttonAsk)
        askMeButton.setOnClickListener{shakeBall()}
    }

    private fun shakeBall() {
        val ballImageViewAsk : ImageView = findViewById(R.id.imageView)
        ...
        ballImageViewAsk.setImageResource(imageResource)
    }
}